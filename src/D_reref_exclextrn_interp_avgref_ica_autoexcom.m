...
paradigm_name  = {'Optical_flow' 'ASSR' 'Beep-flash' 'FAST' 'IllusoryContours' 'resting_state'};
...
for paradigm=5%1:length(home_path)
    ...
    save([home_path{paradigm} 'components'], 'components');
    save([home_path{paradigm} paradigm_name{paradigm} '_participant_interpolation_info'], 'participant_badchan');
end
