...
for s=1:length(subject_list)
    ...
    if strcmp(subject_list{s}, '12675')%had the eye cue as 15
        EEG  = pop_binlister( EEG , 'BDF', [binlist_location '\binlist_bf_old.txt'], 'IndexEL',  1, 'SendEL2', 'EEG', 'Voutput', 'EEG' );
    else
        EEG  = pop_binlister( EEG , 'BDF', [binlist_location '\binlist_bf.txt'], 'IndexEL',  1, 'SendEL2', 'EEG', 'Voutput', 'EEG' );
    end
